...
class CustomAppTheme {
  ...
  static const Color nearlyDarkBlue = Color(0xFF0d2132);
  ...
  static const TextStyle greyText = TextStyle( 
    ...
    fontSize: 14, // was lightText
  );

  static const TextStyle dartGreyText = TextStyle( 
    fontFamily: 'WorkSans',
    color: CustomAppTheme.dark_grey,
    fontWeight: FontWeight.bold,
    fontSize: 20, // was lightText
  );
  ...
  static ThemeData buildLightTheme() {
    Color primaryColor = HexColor("#0a8da6");
